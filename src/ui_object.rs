...
impl UIEntity for UIObject {
    fn render(&self, ui_shader: &shader::ShaderProgram){
        ui_shader.set_uniform_mat4("model", &self.model_mat);
        self.mesh.render(&ui_shader, &self.texture_difuse, None);
    }
...
impl UIObject {
    ...
    pub fn new(name: &str, texture_name: &str) -> UIObject {
        ...
        UIObject{name, pos, scale, model_mat, mesh, texture_difuse, texture_normal, last_pos}
    }
